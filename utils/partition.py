...
def partition_data(dataset, K, partition, n_parties, beta, seed, dict_test_used={}, test_flag=False):
    np.random.seed(seed)
    random.seed(seed)
    ...
    n_train = df.shape[0]
    y_train = df['labels']
    # print("n_train: ", n_train, "::", " y_train: ", y_train)
    ...
    if partition == "homo":
        ...
        while min_size < min_require_size:
            ...
            for k in range(K):
                ...
                if(test_flag):
                    # print("dict_test_used: ", len(dict_test_used[k]), " == ", dict_test_used)
                    idx_k=np.array(list(set(idx_k)-set(dict_test_used[k])))
                    # print("idx_k: ", idx_k, type(idx_k), len(idx_k))          
                ...
                # print("proportions 2: ", proportions, "\n sum: ", proportions.sum())
        ...
        # print("net_data_idx: ", net_dataidx_map)
